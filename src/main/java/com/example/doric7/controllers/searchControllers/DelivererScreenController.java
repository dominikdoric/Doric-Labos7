...
import com.example.doric7.app.screens.searchScreens.DelivererScreen;
...
public class DelivererScreenController {
    ...
    public void onAddNewCategoryClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric7/addNewCategoryScreen.fxml"));
    ...
    public void onAddNewIngredientClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewIngredientsScreen.fxml"));
    ...
    public void onAddNewMealClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewMealScreen.fxml"));
    ...
    public void onAddNewChefClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewChefScreen.fxml"));
    ...
    public void onAddNewWaiterClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewWaitersScreen.fxml"));
    ...
    public void onAddNewDelivererClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewDelivererScreen.fxml"));
    ...
    public void onAddNewRestaurantClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewRestaurantScreen.fxml"));
    ...
    public void onAddNewOrderClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewOrderScreen.fxml"));
    ...
    public void onAddNewContractsClick() {
        FXMLLoader fxmlLoader =
                new FXMLLoader(DelivererScreen.class.getResource("/com/example/doric/addNewContractsScreen.fxml"));
