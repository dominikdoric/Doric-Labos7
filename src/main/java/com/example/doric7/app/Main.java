...
import com.example.doric7.utils.exception.EntityAlreadyInsertedException;
import com.example.doric7.utils.exception.NumberNotCorrectException;
import com.example.doric7.utils.generics.RestaurantLabourExchangeOffice;
import com.example.doric7.utils.comparators.EmployeesByContractLenghtSorter;
import com.example.doric7.utils.comparators.EmployeesBySalarySorter;
...
public class Main {
    ...
    public static List<Bonus> getBonusesFromFile() {
    ...
    public static List<Contract> getContractsFromFile() {
    ...
    public static List<Chef> getChefsFromFile(List<Contract> contracts, List<Bonus> bonuses) {
    ...
    public static List<Waiter> getWaitersFromFile(List<Contract> contracts, List<Bonus> bonuses) {
    ...
    public static List<Deliverer> getDeliverersFromFile(List<Contract> contracts, List<Bonus> bonuses) {
        List<Deliverer> deliverers = new ArrayList<>();
    ...
    public static List<Ingredient> getIngredientsFromFile(List<Category> categories) {
    ...
    public static List<Meal> getMealsFromFile(List<Category> categories, List<Ingredient> ingredients) {
    ...
    public static List<Restaurant> getRestaurantsFromFile(List<Address> addresses,
                                                           List<Meal> meals,
                                                           List<Chef> chefs,
                                                           List<Waiter> waiters,
    ...
    public static List<Order> getOrdersFromFile(List<Restaurant> restaurants,
                                                 List<Meal> meals,
                                                 List<Deliverer> deliverers) {
